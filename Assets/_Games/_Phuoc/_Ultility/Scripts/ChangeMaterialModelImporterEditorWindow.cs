...
namespace MyExtension
{
    ...
    public class ChangeMaterialModelImporterEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/MyExtension/ChangeMaterialModelImporter")]
        public static void OpenEditorWindow()
        {
            ChangeMaterialModelImporterEditorWindow win = new ChangeMaterialModelImporterEditorWindow();
        ...
        private void DrawCurrentModelImporterSelect()
        {
            ...
            for (int i = 0; i < m_SelectedObjects.Count; i++)
            {
                GUILayout.Label(string.Format("{0}: {1}", m_SelectedObjects[i].GetType().Name, m_SelectedObjects[i].name));
            }
        }

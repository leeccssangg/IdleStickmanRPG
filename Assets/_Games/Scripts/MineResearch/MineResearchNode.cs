...
public class MineResearchNode : ScriptableObject
{
    ...
    [OnValueChanged("OnValueChange")]
    public List<MineResearchLevelData> m_TalentLevelDatas;

    [OnValueChanged("OnValueChange")]
    public List<MineResearchNode> m_RequireNode;
    [OnValueChanged("OnValueChange")]
    public MineResearchType m_NodeType;

    public int GetTalentMaxLevelUpgrade()
    {
        return m_TalentLevelDatas.Count;
    }
    public MineResearchType GetNodeType()
    {
        return m_NodeType;
    }
    public void SetNodeType(System.Enum value)
    {
        m_NodeType = (MineResearchType) value;
    }
#if UNITY_EDITOR
    [HideInInspector]
...
[System.Serializable]
public class MineResearchLevelData
{
    public int m_Cost;
    public int m_TimeResearch;
    public int m_Value;
